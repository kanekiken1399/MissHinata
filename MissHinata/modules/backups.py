...
from MissHinata import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from MissHinata.__main__ import DATA_IMPORT
from MissHinata.modules.helper_funcs.chat_status import user_admin
from MissHinata.modules.helper_funcs.alternate import typing_action

# from MissHinata.modules.rules import get_rules
import MissHinata.modules.sql.rules_sql as rulessql

# from MissHinata.modules.sql import warns_sql as warnssql
import MissHinata.modules.sql.blacklist_sql as blacklistsql
from MissHinata.modules.sql import disable_sql as disabledsql

# from MissHinata.modules.sql import cust_filters_sql as filtersql
# import MissHinata.modules.sql.welcome_sql as welcsql
import MissHinata.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    f = open("MissHinata{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("MissHinata{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `MissHinata-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("MissHinata{}.backup".format(chat_id))  # Cleaning file
